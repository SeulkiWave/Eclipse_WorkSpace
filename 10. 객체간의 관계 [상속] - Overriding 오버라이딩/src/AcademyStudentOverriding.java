public class AcademyStudentOverriding extends AcademyMemberOverriding {
	...
	public AcademyStudentOverriding() {}
	public AcademyStudentOverriding(int num, String name, String groupStu) {
		this.num = num;
		this.name = name;
